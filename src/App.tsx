    ...
    <div className="min-h-screen pt-32 pb-20 px-6 max-w-6xl mx-auto">
      <div className="grid md:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <button onClick={() => window.open('/dist/易哲豪简历.pdf', '_blank')} className="bg-black text-white px-8 py-4 rounded-2xl font-bold flex items-center gap-2 neo-shadow neo-shadow-hover">
            <User size={20} />
            查看简历
          </button>
        </motion.div>
